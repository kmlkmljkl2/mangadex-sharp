...
{
    internal class PaginatedCollection<TDto, TResource>
        ...
        where TResource : MangaDexResource
    {
        ...
        private ListQueryParameters _queryParameters;
            ...
            bool requiresAuth = false)
        {
            ...
            TotalPages = (int)Math.Ceiling((double)totalLength / ItemsPerPage);
        ...
        private async Task<CollectionPage<TResource>> LoadPage(int page, CancellationToken cancelToken)
        {
            ...
            _queryParameters.Position = index * ItemsPerPage;
