...
{
    /// <summary>
    /// Keys for <seealso cref="MangaLinks"/>
    /// </summary>
    /// <remarks>Learn more here: https://api.mangadex.org/docs.html#section/Static-data/Manga-links-data </remarks>
    public static class MangaLinksKeys
    {
